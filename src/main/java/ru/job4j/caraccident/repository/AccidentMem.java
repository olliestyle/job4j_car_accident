...
public class AccidentMem {
    ...
    public AccidentMem() {
        ...
        accidents.put(1, new Accident(1, "one", "oneText", "oneAddress", types.get(0)));
        accidents.put(2, new Accident(2, "two", "twoText", "twoAddress", types.get(1)));
        accidents.put(3, new Accident(3, "three", "threeText", "threeAddress", types.get(2)));
    }
